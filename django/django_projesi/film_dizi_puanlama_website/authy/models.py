...
# Kullanıcı profili otomatik olarak oluşturulsun
def create_user_profile(sender, instance, created, **kwargs):
	if created:
		Profile.objects.create(user=instance)

# Kullanıcı profili kaydedilsin
def save_user_profile(sender, instance, **kwargs):
	instance.profile.save()

# Yeni bir kullanıcı oluşturulduğunda ve kaydedildiğinde bu işlevler otomatik olarak çalışacak

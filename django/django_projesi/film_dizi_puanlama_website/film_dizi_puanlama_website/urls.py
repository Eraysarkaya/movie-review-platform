"""
URL configuration for film_dizi_puanlama_website project.
...
from authy.views import UserProfile, ReviewDetail, like, unlike, UserProfileMoviesWatched, UserProfileSeriesWatched, UserProfileWatchList, UserProfileMoviesReviewed, delete_comment
